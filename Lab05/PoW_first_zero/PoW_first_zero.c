...
int main(int argc, char *argv[]) {
    int index = 0, added_space;
    long input_file_size;
    char *input_file_content, hex_string[HEX_STRING_LENGTH], *line_to_append, *hex_id, *requested_ehuskoins;
    ...
    input_file_content = (char *) malloc(added_space); 
    ...
    hash[0] = 0x10; // dummy starting value
    while (hash[0] != 0) {
